...
if(empty($id)){
    if(!empty($userData)){
        ...
        $message->setMessage("Usuário não foi encontrado!1" , "error", "index.php");
    }
} else {

    $userData = $userDao->findById($id);
    if(!$userData){
        $message->setMessage("Usuário não foi encontrado!2" , "error", "index.php");
    }
}
