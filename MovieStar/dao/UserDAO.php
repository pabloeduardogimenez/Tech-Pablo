...
class UserDAO implements UserDAOinterface{
    ...
    public function verifyToken($protected = false){
        if(!empty($_SESSION["token"])){
            ...
            if ($user) {
                ...
                $this->message->setMessage("Faça a autenticação para acessar este página !", "error",   
                "index.php");                 
            }
        } else if($protected){
             // Redireciona usuario não autenticado
    ...
    public function authenticateUser($email, $password) {
        ...
        $this->message->setMessage($user->passwor, "error", " ");
        ...
        if ($user) {
            if (password_verify($password, $user->password)) {
                ...
                return false;
                $this->message->setMessage("Error autenticação1!", "error", " ");
    ...
    public function destroyToken() {
        ...
        $_SESSION["token"] = "";
        //Redirecionar e apresentar a messagem de sucesso
